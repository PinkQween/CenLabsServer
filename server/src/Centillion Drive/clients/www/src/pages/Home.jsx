        ...
        <div ref={backgroundRef} className={'animated-background justify-center align-middle items-center flex space-between ' + (isMobile ? '-mt-[5.5rem]' : '-mt-12')}>
          <div className="flex">
            ...
            <div className="card professional-use-card">
              ...
              <button className='bg-white rounded-lg text-black text-xl p-6 font-bold border-solid border-black border-2' onClick={() => navigate('/dashboard')}>Open in {browserName}</button>
            </div>
          </div>
        </div>
      </div>
